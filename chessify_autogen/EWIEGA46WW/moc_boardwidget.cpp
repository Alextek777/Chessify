...
QT_MOC_LITERAL(1, 12, 18), // "currentCellChanged"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 5), // "Move*"
QT_MOC_LITERAL(4, 38, 7) // "curCell"

    },
    "BoardWidget\0currentCellChanged\0\0Move*\0"
    "curCell"
};
...
void BoardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->currentCellChanged((*reinterpret_cast< Move*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (BoardWidget::*)(Move * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BoardWidget::currentCellChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BoardWidget::currentCellChanged(Move * _t1)
{
